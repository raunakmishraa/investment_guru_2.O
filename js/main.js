      ...
      <section class="youtube-media-section" id="youtube-media">
        <div class="container">
          <div class="youtube-section-head" data-aos="fade-up">
            ...
            <p>Follow Investment Guru for market education and analysis, or switch to The Amit Show for deeper conversations, stories and perspectives from the world of investing.</p>
          </div>
          ...
          <div class="youtube-panel active" data-youtube-panel="investment" role="tabpanel">
            <div class="youtube-panel-top"><div><span class="youtube-channel-label">Investment Guru • YouTube</span><h3>Latest market insights &amp; practical lessons.</h3></div><a class="youtube-channel-link" href="https://www.youtube.com/@InvestmentGuru_np" target="_blank" rel="noopener">Visit Channel ↗</a></div>
            <div class="youtube-video-grid">
              <a class="youtube-video-card" href="https://www.youtube.com/@InvestmentGuru_np" target="_blank" rel="noopener"><div class="youtube-thumb youtube-channel-thumb"><span class="channel-mark">IG</span><span class="play-button">▶</span></div><div class="youtube-video-meta"><span>INVESTMENT GURU</span><h4>Market Analysis &amp; Education</h4><p>Regular market updates, technical analysis and practical investing lessons.</p></div></a>
              <a class="youtube-video-card" href="https://www.youtube.com/@InvestmentGuru_np" target="_blank" rel="noopener"><div class="youtube-thumb youtube-channel-thumb"><span class="channel-mark">IG</span><span class="play-button">▶</span></div><div class="youtube-video-meta"><span>NEPSE SCHOOL</span><h4>Learn the Nepal Stock Market</h4><p>Explore educational content covering market basics, trading and investment strategy.</p></div></a>
              <a class="youtube-video-card" href="https://www.youtube.com/@InvestmentGuru_np" target="_blank" rel="noopener"><div class="youtube-thumb youtube-channel-thumb"><span class="channel-mark">IG</span><span class="play-button">▶</span></div><div class="youtube-video-meta"><span>INVESTMENT GURU</span><h4>Explore More Videos</h4><p>Watch the latest Investment Guru content directly on the official channel.</p></div></a>
            </div>
          </div>
          <div class="youtube-panel" data-youtube-panel="podcast" role="tabpanel" hidden>
            <div class="youtube-panel-top"><div><span class="youtube-channel-label">The Amit Show • YouTube</span><h3>Long-form conversations worth listening to.</h3></div><a class="youtube-channel-link" href="https://www.youtube.com/@InvestmentGuru_np" target="_blank" rel="noopener">Watch The Amit Show ↗</a></div>
            <div class="youtube-video-grid">
              <a class="youtube-video-card" href="https://www.youtube.com/@InvestmentGuru_np" target="_blank" rel="noopener"><div class="youtube-thumb youtube-channel-thumb podcast"><span class="channel-mark">AS</span><span class="play-button">▶</span></div><div class="youtube-video-meta"><span>THE AMIT SHOW</span><h4>Conversations with Market Voices</h4><p>Long-form interviews and perspectives from the world of investing.</p></div></a>
              <a class="youtube-video-card" href="https://www.youtube.com/@InvestmentGuru_np" target="_blank" rel="noopener"><div class="youtube-thumb youtube-channel-thumb podcast"><span class="channel-mark">AS</span><span class="play-button">▶</span></div><div class="youtube-video-meta"><span>THE AMIT SHOW</span><h4>Stories Beyond the Market</h4><p>Conversations around careers, entrepreneurship, finance and personal growth.</p></div></a>
              <a class="youtube-video-card" href="https://www.youtube.com/@InvestmentGuru_np" target="_blank" rel="noopener"><div class="youtube-thumb youtube-channel-thumb podcast"><span class="channel-mark">AS</span><span class="play-button">▶</span></div><div class="youtube-video-meta"><span>PODCAST</span><h4>Explore The Amit Show</h4><p>Watch more episodes and discover upcoming conversations on the official channel.</p></div></a>
            </div>
          </div>
        </div>
      </section>`;
