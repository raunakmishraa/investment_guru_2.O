...
const TRAININGS = [
  {
    ...
    description:
      "Build a strong foundation and understand the market before you put your money to work.",
    fullDescription:
      "Master core market mechanics, stock evaluation, and risk fundamentals tailored for beginners in NEPSE.",
    features: [
  ...
  },
  {
    ...
    description:
      "Learn to read price action, identify trends and make structured market decisions.",
    fullDescription:
      "Learn in-depth chart reading, price action patterns, momentum indicators, and systematic trade setups.",
  ...
  },
  {
    ...
    description:
      "A structured path from fundamentals to practical market skills and strategy building.",
    fullDescription:
      "A comprehensive end-to-end curriculum bridging fundamentals to professional trading and portfolio growth.",
  ...
  },
  {
    ...
    description:
      "Sharpen your execution, discipline and understanding of market movement.",
    fullDescription:
      "Sharpen your execution, psychological discipline, and multi-timeframe swing and intraday strategies.",
  ...
  },
  {
    ...
    description:
      "Understand mistakes, rebuild discipline and create a more structured investing process.",
    fullDescription:
      "Diagnostic training to audit past mistakes, rebuild risk management rules, and restore capital growth.",
